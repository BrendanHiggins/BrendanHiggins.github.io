...
<!--more-->
<div>
  <small style="text-align:justify;font-weight:bold;color:#FFE46B">The material and information contained on this page is for general information and educational purposes only. The author of this page does not support or promote the illegal production, distribution, or use of any fraudulent documents.</small>
</div>
<hr>
...
Okay, so not really, though. I have absolutely no intent to fraudulently use, distribute, or sell any fake COVID-19 cards.

But - I am legitimately curious how hard it is to make one. Also, someone somewhere in the government thought simple black and white paper cards was a good idea. So lets do what we do in cybersecurity and test for vulnerabilities and discuss mitigations. 

# Making A Fake 

### Adobe Products
I'm fairly convinced the CDC/HHS produced the master template for the real and authentic COVID-19 card in an Adobe program, but since I have very little real in-depth knowledge of the full [Adobe Creative Suite](https://en.wikipedia.org/wiki/Adobe_Creative_Suite), I couldn't really pinpoint which one.

#### Microsoft Word / Google Docs
I didn't waste my time trying to remake the card in Microsoft Word or Google Docs, but I'm sure it's possible if you're dedicated enough. For me, this project wasn't about testing every possible method of reproduction, and banging my head into word document programs didn't sound like any fun.
...
But then again, I'm not sure why I'm bothering with so much opsec around the card images because it's basically a joke with how easy it is to find high resolution images of the card. If only everyone had followed that FBI advice.
...
For now, let us not disrespect our age-old friends: paper, ink, and printers -- they have more tricks up their sleeves some may expect.

#### COVID-19 Card Security Measures Taken:
Non-Standard Paper Grammage (Paper "Weight") and page size.

The vaccine verification could have easily been piece of 20lb A4 printer paper that was handed to you after successful injection. The CDC/HHS at least seemed to find that 4x3" card stock was a more convenient and, possibly unintentionally, a more difficult format to reproduce.
...
The only other "feature" the card really has is unique spacing/margins around certain elements. Perhaps there's other more discrete features that I'm oblivious to?
...
To put this into comparison, this week the #1 book on Amazon is Stephen King's "Billy Summers", which released on August 3rd. According to [Publishers Weekly](https://www.publishersweekly.com/pw/nielsen/top100.html), "Billy Summers" has sold at least 146,000 units YTD. Let's assume that number is accurate, and doesn't account for E-Book Sales, for sake of the example (and given that novel has only been out for 2 weeks.)
...
A few states are pursuing vaccination cards as a "passport" to engage with society at large more seriously than most. Of those, NY and CA seem the most invested, and even put resources into digital vaccination verification systems. Lets take a look at those!

## New York (City)

#### How It's Supposed to Work:
![NYC](/assets/images/covid-cards/NYC_covid_safe.jpg)

#### What People Actually Did With it:
<div style="display: flex;">
  <div style="flex: 50%;border:1px solid black;">
    <img src="/assets/images/covid-cards/NYC_lol0.jpg" style="width:100%">
  </div>
  <div style="flex: 50%;border:1px solid black;">
    <img src="/assets/images/covid-cards/NYC_lol1.png" style="width:100%">
  </div>
</div>
...
In this case, per JSON Web Token (JWT) [RFC7519](https://datatracker.ietf.org/doc/html/rfc7519), the "d" variable is private to the state signing official. Unless you know how to reverse Ellipitcal Curve Digital Signing Algorithms, you're out of luck for reproducing your own crypographically verifiable key.
...
A huge barrier to entry for vax card fraud would be \$500- \$1500 card printers. The only reason I can imagine this very "Drivers License" approach was rejected was due to potential cost overrun.

It would have been really convenient to be mailed a nice plastic card with my picture, name, and a unique identifying digital hash/QR that matches to state/federal vaccination records updated digitally in a centralized database to track initial vaccine, subsequent boosters, etc.

That all sounds a little dystopian, perhaps...but I might take a functional, well-thought out system over the disfunction and unreliability that we have currently. 
